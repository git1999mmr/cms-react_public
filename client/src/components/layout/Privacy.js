    ...
    <Fragment>
      ...
      <div className="text-dark container" style={{ marginTop: '1%' }}>
        <p className="p">
          ...
          of information that is collected and recorded by Construction
          Management System and how we use it.
        </p>
        ...
        <p className="p">
          ...
          shared and/or collect in Construction Management System. This policy
        ...
        <p className="p">
          Construction Management System follows a standard procedure of using
        ...
        <p className="p">
          Like any other website, Construction Management System uses 'cookies'.
        ...
        <p className="p">
          ...
          advertising partners of Construction Management System.
        </p>
        <p className="p">
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Construction Management
          System, which are sent directly to users' browser. They automatically
        ...
        <p className="p">
          Note that Construction Management System has no access to or control
        ...
        <p className="p">
          Construction Management System's Privacy Policy does not apply to
        ...
        <p className="p">
          Construction Management System does not knowingly collect any Personal
